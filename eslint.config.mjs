...
export default tseslint.config(
  ...
  {
    // Tooling configuration is CommonJS and runs in Node.
    files: ['**/*.cjs'],
    languageOptions: {
      sourceType: 'commonjs',
...

  {
     ...
     * These files are the ones the clean-architecture work (#46) is about to
     * replace, so rewriting their imports now would only cause conflicts.
     * They warn instead of failing, and the count shows in every CI run.
     */
    files: [
      'src/index.ts',
      'src/routes/**/*.ts',
